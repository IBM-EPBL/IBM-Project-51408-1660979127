  ...
  <div className="ihd__features section__padding" id="features">
    <div className="ihd__features-heading">
      <h1 className="gradient__text">
        Here are some treatment options for heart diseases.
      </h1>
      <p>
        Heart disease treatment depends on the cause and type of heart damage.
        Healthy lifestyle habits — such as eating a low-fat, low-salt diet,
        getting regular exercise and good sleep, and not smoking — are an
